		...
		OnGestureListener
{
	...
	private static final int AVE_ID = 20;
	private static final int AVE_TEXT_ID = 21;
...
//			root.addView(canvasView, 0);
		...
		btnAVE = new Button (res, R.drawable.btn_record1, R.drawable.btn_record2, Align.BOTTOM_LEFT);
		txtAVE = new Text(context, "      AVE", Align.BOTTOM_LEFT);
		txtAVE.setMargin((int)res.getDimension(R.dimen.hud_rec_text_margin_top),
				0,
				0,
				(int)res.getDimension(R.dimen.hud_rec_text_margin_right));
		btnAVE.setMargin(0,0,0,res.getDimensionPixelOffset(R.dimen.hud_btn_rec_margin_right));
		...
		renderer.addSprite(AVE_ID, btnAVE);
		renderer.addSprite(AVE_TEXT_ID,txtAVE);
	}
	...
	public void setBtnAveClickListener(OnClickListener listener)
	{
